...
const footerLinks = {
  ...
  services: [
    { name: "Breed Consultation", href: "/services/consultation" },
    { name: "Farm Setup", href: "/services/setup" },
    { name: "Health Management", href: "/services/health" },
        ...
        <div className="mt-12 border-t border-divider pt-8">
          <div className="flex items-center justify-between">
            ...
            <p className="text-sm leading-5 text-default-600">
              &copy; {new Date().getFullYear()} Vicky&apos;s Farm. All rights reserved.
            </p>
          </div>
        </div>
      </div>
